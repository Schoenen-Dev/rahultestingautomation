...
(async function run() {
  ...
  async function login() {
    ...
    try {
      ...
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtLogin")).sendKeys("Sfranco");
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtPassword")).sendKeys("Sergie03141978##");
