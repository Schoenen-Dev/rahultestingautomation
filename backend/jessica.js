...
(async function run() {
  ...
  async function login() {
    ...
    try {
      ...
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtLogin")).sendKeys("jbelanger1");
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtPassword")).sendKeys("Nellysinz@2026!!");
