...
const ALLOWED_ZIPS = [
"02905","02910","02920","02921","02889","02886","02888","02909","02893","02907","02908"];
...
(async function run() {
  ...
  async function login() {
    ...
    try {
      ...
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtLogin")).sendKeys("kdoheny");
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtPassword")).sendKeys("$Newenglandpats2026");
