...
options.addArguments("--window-size=1280,900");
  ...
  async function login() {
    ...
    try {
      ...
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtLogin")).sendKeys("wrampersad");
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtPassword")).sendKeys("@Groundworks1989!");
        ...
        if (elems.length > 0) {
          ...
          try {
            ...
            try {
              ...
              fs.appendFileSync("valuenet_log.txt", `[${getTimestamp()}] ACCEPTED - Websocket\n${txt}\n-----------------\n`);
            } catch (e) {
              fs.appendFileSync("valuenet_log.txt", `[${getTimestamp()}] ACCEPTED — row not readable\n-----------------\n`);
            }
