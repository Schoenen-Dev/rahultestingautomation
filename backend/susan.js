...
(async function run() {
  ...
  async function login() {
    ...
    try {
      ...
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtLogin")).sendKeys("sgbonura");
      await driver.findElement(By.id("ctl00_ContentPlaceHolder1_txtPassword")).sendKeys("Blessedblessed65!");
